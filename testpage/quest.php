	...
	<body class='new_body' style="overflow: auto;">
		<div class='wrapper'>
			...
			<main class='_main _main_auth'>
				<section class='_quest_block'>
					<div class='_quest_block__container'> 
						<div class='_quest_block__content'>
							<h2 class='_quest_block__htwotitle'>Популярыне вопросы</h2>
							<div class='quest_block__m'>
								<details open>
									<summary>
