				...
				<section class='_auth_block'>
					<div class='_auth_block__container'> 
						<div class='_auth_block__content'>
							<h2 class='_auth_block__htwotitle'>Авторизация</h2>
							<input type='text' name='input_auth_test' placeholder='Ваше имя' class='_auth_block__input'>
							<button class='_auth_block__button'>Отправить</button>
						</div>
					</div>
				</section>
			</main>
